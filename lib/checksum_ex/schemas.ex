defmodule ChecksumEx.Schemas do
  @moduledoc """
  Generated schema structs from the Checksum OpenAPI specification.
        ...
        defp convert_field(key, value) do
          case Map.get(@conversions, key) do
            {:struct, ref_name} when is_map(value) ->
              Module.concat(ChecksumEx.Schemas, ref_name).from_map(value)

            {:list, ref_name} when is_list(value) ->
              mod = Module.concat(ChecksumEx.Schemas, ref_name)
