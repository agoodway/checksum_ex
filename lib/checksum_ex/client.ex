defmodule ChecksumEx.Client do
  @moduledoc """
  HTTP client for the Checksum API.
    ...
    %__MODULE__{
      base_url:
        Keyword.get(opts, :base_url) ||
          Application.get_env(:checksum_ex, :base_url, "http://localhost:4000"),
      api_key:
        Keyword.get(opts, :api_key) ||
          Application.get_env(:checksum_ex, :api_key),
